...
/**
 * Marker base for the "test-app" states, letting the debugger runner recognise a test launch
 * regardless of which Grails generation produced it.
 */
public abstract class GrailsTestAppCommandLineState extends GrailsCommandLineState {

  protected GrailsTestAppCommandLineState(@NotNull ExecutionEnvironment environment,
