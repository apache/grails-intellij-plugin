...
public class GoToServiceAction extends GrailsGoToArtefactActionBase {

  public GoToServiceAction() {
    super(GrailsArtifact.SERVICE);
  }

  @Override
  public @NotNull Collection<AnAction> createGenerateActions(@NotNull ArtefactData artefactData) {
    return List.of(ActionManager.getInstance().getAction("Grails.Service"));
  }
}
