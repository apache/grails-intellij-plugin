...
public final class TaglibArtefactHandler implements GrailsDisplayableArtefactHandler {

  public static final TaglibArtefactHandler INSTANCE = new TaglibArtefactHandler();

  private TaglibArtefactHandler() {
  }
  ...
  public @Nullable VirtualFile getDirectory(@NotNull GrailsApplication application) {
    return application.getAppRoot().findChild("taglib");
  }

  @Override
  public @NotNull Collection<String> getAnnotationFqns() {
    return List.of("grails.gsp.TagLib");
  }

  @Override
  public @NotNull Icon getIcon() {
    return GroovyMvcIcons.Taglib;
  }
  ...
  public int getWeight() {
    return NodeWeights.TAGLIB_FOLDER;
  }
}
